  ...
  return (
    <div className="about-section" id="about">
      ...
      <p className="about-description">
        I am a Frontend Developer profecient in HTML CSS JavaScript and
        React.js. I have build some Projects using HTML CSS JavaScript and a
      ...
      <div className="projects-section">
        ...
        <div className="projects-wrapper">
          ...
          <br />
          <div className="project-image">
            <img src={DevDetectiveImage} width="70%" h />
            <p>
              DEV DETECTIVE | <br />
